...
<head>
  ...
  <title>Verifications Users</title>
...
<body>
  ...
  <div class="dashboard" id="body">
    ...
    <header>
      <h1>Verifications Users</h1>
    </header>
    <button id="back-button" onclick="window.location.href='instructor.php'">Back</button>
        ...
        <div style="width: auto; height:300px; overflow-y: scroll;">
          <table>
            ...
            <?php
               ...
               $sql = "SELECT user_id, email, user_name, NIC, gender, p_number, age 
                      FROM users 
        ...
        <div style="width: auto; height:300px; overflow-y: scroll;">
          <table>
            ...
            <?php
              ...
              $sql = "SELECT user_id, email, user_name, NIC, gender, p_number, age
                       FROM users 
                       WHERE instructor_status = 1 AND instructor_pyamnet_slip != 'null' AND instructor = '$ins_id'";
              $result = $conn->query($sql);
